        ...
        <div>
            <header style={masterHeader}>
                <div className='h-100' style={{ background: 'rgba(0,0,0,0.7)'}}>
                    <div className='h-100x container'>
                ...
                <div className='container'>
                    ...
                    <form>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" value={form.comments} onChange={onChange('comments')} className="form-control" id="comentario" placeholder="Comentário" />
                        </div>
                        <div className="form-group">
